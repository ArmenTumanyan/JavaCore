...
public class BraceChecker {
    ...
    public void check() {
        ...
        for (int i = 0; i < text.length(); i++) {
            ...
            switch (c) {
                ...
                case ')':
                    last = stack.pop();
                    if (last == 0) {
                        System.out.println("Error at " + i + "closet " + c + " but not opened ");
                    } else {
                        lastBracket = (char) last;
                        if (lastBracket != '(')
                            System.out.println("Error at " + i + " open " + lastBracket + "but closet" + c);
                    }
        ...
        //    System.out.println("Error: opened " + lastBracket + " but not closet");
        //}
        while (!stack.isEmpty()) {
